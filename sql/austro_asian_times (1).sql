...
--
-- Host: 127.0.0.1
-- Generation Time: Jan 19, 2026 at 07:48 PM
...
INSERT INTO `advertisements` (`ad_id`, `image_url`, `link_url`, `position`, `start_date`, `end_date`, `status`) VALUES
(2, 'uploads/ad_696e7801e4b9c.jpg', '', 'home_top', '2026-01-20 00:29:21', NULL, 'active');
...
(7, 8, 'very nice', '2025-08-29 15:42:54', 'Rifat', 'approved'),
(8, 8, 'very nice', '2025-08-29 15:43:38', 'Rifat', 'pending');
...
INSERT INTO `popups` (`popup_id`, `content`, `is_active`, `created_at`) VALUES
(2, 'Justice For Hadi...!!', 1, '2026-01-19 18:35:47');
...
INSERT INTO `subscription_plans` (`plan_id`, `name`, `price`, `duration_days`, `description`, `created_at`) VALUES
(1, 'Monthly', 30.00, 30, 'one month', '2026-01-19 18:26:09');
...
INSERT INTO `user_subscriptions` (`subscription_id`, `user_id`, `plan_id`, `start_date`, `end_date`, `status`) VALUES
(1, 2, 1, '2026-01-20 00:31:02', '2026-02-18 19:31:02', 'expired'),
(2, 2, 1, '2026-01-20 00:34:41', '2026-02-18 19:34:41', 'active');
...
--
ALTER TABLE `popups`
  MODIFY `popup_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
